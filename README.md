...
Linear LangGraph pipeline of specialist agents. The current graph is `START -> idea_generation_agent -> END`.

The idea generation agent searches the web and keeps market categories whose Google Trends (worldwide, since 2004) slope smoothly upward.
